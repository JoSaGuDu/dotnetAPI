...
namespace dotnet_asp_API.Models
{
    public class CityDto
    {
        ...
        public int NumberOfPointsOfInterest//This shouldn't be part of the entity class as it is calculated on the fly and no have to interact with the database.TO BE REFACTORED.
        {
            get
            {
        ...
        //Extend CityDto to show list of points of interest
